...
# 남게 한다.
# 2026-09-02: "날씨 정보에 대해서 설명해줘"에서 위 정규식이 "에 대해"까지만
# 지우고 뒤에 붙는 "서"(-해서/-하여서 어미)를 못 지워서 "정보 서 설명해줘"
# 처럼 고립된 "서"가 남는 버그가 실제 운영 로그에서 확인됨. "서"는 선택
# 매칭으로 추가만 하면 되고, "에 대해"/"에 대하여"(서 없는 기존 형태)는
# 그대로 동일하게 지워진다.
